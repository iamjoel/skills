...
- `功能 Review` 至少包含一个详情单元，并按独立缺陷、根因或受影响路径重复；不要把不相关路径合并为一个单元。
...
- 类型：<没有从根因修复 | 引入了新的问题 | 代码质量问题 | 性能问题>
- 具体说明：<结合真实触发或消费路径和代码说明修复、回归、代码质量或性能风险>
...
- 建议修复：<给出可执行的根因修复、回归消除、代码质量调整或性能优化方向>
