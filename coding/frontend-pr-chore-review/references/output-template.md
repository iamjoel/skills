...
- `功能 Review` 至少包含一个详情单元，并按独立依赖、配置、工具、生成或发布职责重复；不要把不相关维护合并为一个单元。
...
- 类型：<没有完成维护目标 | 引入了新的问题 | 代码质量问题 | 性能问题>
- 具体说明：<结合真实工程、用户或消费路径和代码说明维护、回归、代码质量或性能风险>
...
- 建议修复：<给出可执行的维护补全、回归消除、代码质量调整或性能优化方向>
